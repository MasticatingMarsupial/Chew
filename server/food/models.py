...
class Account(models.Model):
  ...
  food_favorites = models.ManyToManyField(Food, related_name='food_favorited+')
  food_liked = models.ManyToManyField(Food, related_name='food_liked+')
  food_disliked = models.ManyToManyField(Food, related_name='food_disliked+')
  images_liked = models.ManyToManyField(Image, related_name='images_liked')
  search_preferences = models.OneToOneField(Setting, null=True)
  reviews_liked = models.ManyToManyField(Review, related_name='review_liked+')
  reviews_disliked = models.ManyToManyField(Review, related_name='review_disliked+')
